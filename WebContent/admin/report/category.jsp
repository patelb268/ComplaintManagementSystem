            ...
            <table class="table table-hover">
                ...
                <tbody>
                    <%
                    	...
                    	PreparedStatement ps = con.prepareStatement("select id,title,description,open,dept_id,technician_id,user_id,close,nvl(truncate((close-open),0), -1) from complaints where category_id=? order by id desc");
